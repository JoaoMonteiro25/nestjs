...
import { CriaProdutoDTO } from '../../modulos/produto/dto/CriaProduto.dto';
import { ProdutoCaracteristicaEntity } from '../../modulos/produto/produto-caracteristica.entity';
import { ProdutoImagemEntity } from '../../modulos/produto/produto-imagem.entity';
...
describe('CriaProdutoDTO', () => {
  it('Deve ser válido com todos os campos corretos', async () => {
    ...
    dto.caracteristicas = [
      { id: uuidv4(), nome: 'Cor', descricao: 'Preto', produto: null },
    ];
    dto.imagens = [
      {
        id: uuidv4(),
        url: 'https://imagem.com/produto.jpg',
  ...
  it('Deve ser inválido com valor negativo', async () => {
    ...
    dto.nome = 'Produto Teste';
    dto.valor = -10;
    dto.quantidadeDisponivel = 10;
    dto.descricao = 'Descrição do produto';
    dto.categoria = 'Eletrônicos';
    dto.caracteristicas = [
      { id: uuidv4(), nome: 'Cor', descricao: 'Preto', : null },
    ];
    dto.imagens = [
      {
        id: uuidv4(),
